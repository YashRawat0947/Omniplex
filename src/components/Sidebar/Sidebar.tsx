...
const Sidebar = () => {
  console.log("Stripe Publishable Key:", REACT_APP_STRIPE_PUBLISHABLE_KEY);
  ...
  const handleBuyPro = async () => {
    ...
    await stripe.redirectToCheckout({
      lineItems: [{ price: "price_1RnexRRrwDJM8Z08aGQv08kV", quantity: 1 }], // Replace with your Price ID
      mode: "subscription",
      ...
      {isSidebarOpen && (
        <>
          ...
          >
            ...
            {/* Add Stripe Checkout Button here */}
